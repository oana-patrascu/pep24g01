...
an_cautat = input("Introduceți anul pentru căutare: ")

print("Cărțile publicate după anul {} sunt:".format(an_cautat))
for carte in lista_carti:
    if int(carte['an']) > int(an_cautat):
        print("{} a fost publicat după {}.".format(carte['nume'], an_cautat))